...
export const characterCount = {
  ...
  keys: [
    ...
    { name: 'charactersUnderLimitText', type: 'object', title: 'Characters under limit text', hint: `Message displayed when the number of characters is under the configured maximum, \`maxlength\`. This message is displayed visually and through assistive technologies. The component will replace the \`%{count}\` placeholder with the number of remaining characters. [Our pluralisation rules apply to this macro option](https://frontend.design-system.service.gov.uk/localise-govuk-frontend/#understanding-pluralisation-rules).`, required: false, isComponent: false },
    ...
    { name: 'charactersOverLimitText', type: 'object', title: 'Characters over limit text', hint: `Message displayed when the number of characters is over the configured maximum, \`maxlength\`. This message is displayed visually and through assistive technologies. The component will replace the \`%{count}\` placeholder with the number of characters above the maximum.[Our pluralisation rules apply to this macro option](https://frontend.design-system.service.gov.uk/localise-govuk-frontend/#understanding-pluralisation-rules).`, required: false, isComponent: false },
    { name: 'wordsUnderLimitText', type: 'object', title: 'Words under limit text', hint: `Message displayed when the number of words is under the configured maximum, \`maxwords\`. This message is displayed visually and through assistive technologies. The component will replace the \`%{count}\` placeholder with the number of remaining words. [Our pluralisation rules apply to this macro option](https://frontend.design-system.service.gov.uk/localise-govuk-frontend/#understanding-pluralisation-rules).`, required: false, isComponent: false },
    ...
    { name: 'wordsOverLimitText', type: 'object', title: 'Words over limit text', hint: `Message displayed when the number of words is over the configured maximum, \`maxwords\`. This message is displayed visually and through assistive technologies. The component will replace the \`%{count}\` placeholder with the number of characters above the maximum. [Our pluralisation rules apply to this macro option](https://frontend.design-system.service.gov.uk/localise-govuk-frontend/#understanding-pluralisation-rules).`, required: false, isComponent: false }
  ],
  component: {
    id: 'character-count',
    title: 'Character count',
...
export const dateInputItem = {
  ...
  keys: [
    ...
    { name: 'autocomplete', type: 'string', title: 'Autocomplete', hint: `Attribute to meet [WCAG success criterion 1.3.5: Identify input purpose](https://www.w3.org/WAI/WCAG22/Understanding/identify-input-purpose.html), for instance \`"bday-day"\`. See the [Autofill section in the HTML standard](https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#autofill) section in the HTML standard for full list of attributes that can be used.`, required: false, isComponent: false },
    { name: 'pattern', type: 'string', title: 'Pattern', hint: `Attribute to [provide a regular expression pattern](https://html.spec.whatwg.org/multipage/input.html#the-pattern-attribute), used to match allowed character combinations for the input value.`, required: false, isComponent: false },
...
export const input = {
  ...
  keys: [
    ...
    { name: 'autocapitalize', type: 'string', title: 'Autocapitalize', hint: `Optional field to enable or disable autocapitalisation of user input. [See the Autocapitalization section in the HTML spec](https://html.spec.whatwg.org/multipage/interaction.html#autocapitalization) for a full list of values that can be used.`, required: false, isComponent: false },
...
export const passwordInput = {
  ...
  keys: [
    ...
    { name: 'classes', type: 'string', title: 'Classes', hint: `Classes to add to the input.`, required: false, isComponent: false },
    { name: 'autocomplete', type: 'string', title: 'Autocomplete', hint: `Attribute to meet [WCAG success criterion 1.3.5: Identify input purpose](https://www.w3.org/WAI/WCAG22/Understanding/identify-input-purpose.html). See the [Autofill section in the HTML standard](https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#autofill) for full list of attributes that can be used. Default is \`"current-password"\`.`, required: false, isComponent: false },
    { name: 'attributes', type: 'object', title: 'Attributes', hint: `HTML attributes (for example data attributes) to add to the input.`, required: false, isComponent: false },
